...
console.log(myPow(3, 4, myPrint)); // Вывод: 3^4=81
console.log(myPow(2, 3, myPrint)); // Вывод: 2^3=8
/*
 * #4
 *
...
car.used = "used";
console.log(car2.info()); // Infinite FX50 AWD, 5000cc, year 2019, new -- изменения не выполняются0
...
let person = [12, 23, 100, 34, 56, 9, 233];

let myMax = function (arr) {
  return Math.max.apply(null, arr);
};

console.log(myMax(person)); // 233
